...
<div class="container-fluid ">
    ...
    <section class="row mx-0 mt">
        ...
        <div class="col"></div>
        <div class="col-10">
            <form action="?url=edit-Sach&id=<?= $id ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="ten_sach" value="<?= $ten_sach ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputPassword1" name="nam_xuat_ban" value="<?= $nam_xuat_ban ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="tac_gia" value="<?= $tac_gia ?>">
                ...
                <div class="form-group">
                    ...
                    <select name="id_danh_muc" id="" class="form-control" id="exampleInputPassword1">
                        ...
                        <?php foreach ($listDanhMucSach as $dm){
                            ...
                            <option value="<?= $dm['id'] ?>" <?=  $dm['id'] == $id_danh_muc ? "selected" : ""  ?>   ><?= $dm['ten_danh_muc'] ?></option>
                        <?php }?>
                    </select>
