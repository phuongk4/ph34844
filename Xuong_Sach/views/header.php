    ...
    <ul class="navbar-nav  bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="?url=add-DanhMucSach">Thêm Danh Mục Sách</a>
                    <a class="collapse-item" href="?url=list-DanhMucSach">Danh Sách</a>
                </div>
            </div>
        </li>
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            ...
            <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Custom Components:</h6>
                    <a class="collapse-item" href="?url=add-Sach">Thêm Sách</a>
                    <a class="collapse-item" href="?url=list-Sach">Danh Sách</a>
                </div>
            </div>
        </li>
        <!-- Nav Item - User Menu -->
        <li class="nav-item">
            ...
            <div id="user" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Custom Components:</h6>
                    <a class="collapse-item" href="?url=list-NguoiDung">Danh Sách</a>
                    <a class="collapse-item" href="?url=add-NguoiDung">Thêm Người Dùng</a>
                </div>
            </div>
        </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"  method="get" id="form_search">
